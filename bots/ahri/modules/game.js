...
let game = [{
                ...
                for (i in champ) {
                    ...
                    if (champion == __champ__) {
                        ...
                        for (j = 0; j < __champion__.length; j++) {
                            if (j == index || __champion__[j] == ' ' || __champion__[j] == '.') {
                                continue
                            };
...

    {
        ...
        group: 'game',
        result: (msg, args, profile) => {
            if (msg.content !== 'a!stopfight') send(msg, "Doesn't need any argument");
            ...
            if (profile.game.owned === 0) send(msg, 'You didn\'t choose your first champion !\nDo `a!choose`');
                ...
                if (fighting == 1) {
                    ...
                    console.log(App)
                    //if(App.hasOwnProperty(msg.author.id)) App[msg.author.id] = undefined;
